...
$columnId = "time-ago-column-" . Str::random(10);
...
<div {{ $attributes ->merge($getExtraAttributes(), escape: false)
    ...
    ax-load
    ax-load-src="{{ \Filament\Support\Facades\FilamentAsset::getAlpineComponentSrc('rupadana-timeago',
        'rupadana/filament-custom-tables') }}"
    x-data="timeago({
        id: @js($columnId),
